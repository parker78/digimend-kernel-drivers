...
/**
 * Expand to the report descriptor template for (tweaked) v2 pen reports.
 *
 * @_report_id	The ID to use for the pen reports.
 */
#define UCLOGIC_RDESC_PEN_V2_TEMPLATE_BYTES(_report_id) \
	0x05, 0x0D,     /*  Usage Page (Digitizer),                 */  \
	0x09, 0x02,     /*  Usage (Pen),                            */  \
	0xA1, 0x01,     /*  Collection (Application),               */  \
	0x85, (_report_id),                                             \
...
/* Fixed report descriptor template for (tweaked) v1.5 pen reports */
const __u8 uclogic_rdesc_pen_v1_5_template_arr[] = {
	UCLOGIC_RDESC_PEN_V2_TEMPLATE_BYTES(7)
};

const size_t uclogic_rdesc_pen_v1_5_template_size =
			sizeof(uclogic_rdesc_pen_v1_5_template_arr);

/* Fixed report descriptor template for (tweaked) v2 pen reports */
const __u8 uclogic_rdesc_pen_v2_template_arr[] = {
	UCLOGIC_RDESC_PEN_V2_TEMPLATE_BYTES(8)
};
